...
<head>
  ...
  <title>St. Joseph's College of Engineering and Technology (SJCET)</title>
  <meta name="description" content="St. Joseph’s College of Engineering & Technology (SJCET) was founded in the year 2007. It is a Christian Minority Institution of Higher Technical Education, approved by the All India Council for Technical Education [AICTE], NewDelhi, Government of Tamilnadu and affiliated to Anna University, Chennai.">
  <meta name="keywords" content="Engineering colleges in Thanjavur, best engineering colleges in Thanjavur, Thanjavur engineering colleges ,top 10 engineering colleges in Thanjavur, top colleges in Thanjavur, top engineering colleges in Thanjavur, best engineering college in Thanjavur, list of engineering colleges in  Thanjavur, Top engineering colleges in TamilNadu, B.E colleges in Thanjavur, best colleges in Thanjavur, be colleges in Thanjavur, top engineering college in Thanjavur">
...
<section class="container mt-2">
  <div class="row container-fluid equal-cols gx-2 mx-1">
        ...
        <section class="row equal-cols gx-2 mx-1">
          ...
          <article class="col-sm-12 col-md-6 col-lg-4 mb-1" >
            <div title="<?php echo $row['title']?>" class="card w-100" data-aos="fade-in" data-aos-once="true" >
              ...
              <a style="text-decoration:none;color:#444;" href="https://<?php echo(strtolower($row["dept"])) ?>.sjcettnj.edu.in/static/uploads/event/<?php echo $row['pdf']?>" target="_blank"><span class="sjcet-text" style="font-size:14px !important"><?php echo substr($row['title'],0,50).'...'?></span></a><br>
          ...
          <article class="col-sm-12 col-md-12 col-lg-4 mb-1 " style="display: flex;flex-direction: column;justify-content: space-around;align-items:center;">
            ...
            <a class="btn text-center" style="color:#C2001B;border:2px solid #C2001B;border-radius: 15px;max-height:40px;" href="/events&news.php#event">View All Events</a>
          </article>
        </section>
      </div>
    </article>
...
<section class="container-fluid sjcet-box">
  <div class="container p-3" data-aos="fade-up" data-aos-once="true">
    ...
    <article class="row gx-2 mt-4">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4 mb-3">
        <a href="https://ece.sjcettnj.edu.in" class="dept">
        B.E Electronics and Communication Engineering
        </a>
      </div>
      <div class="col-sm-12 col-md-12 col-lg-4 mb-3">
        <a href="https://eee.sjcettnj.edu.in" class="dept">
        B.E Electrical and Electronics Engineering
        </a>
      </div>
      <div class="col-sm-12 col-md-12 col-lg-4 mb-3">
        <a href="https://mech.sjcettnj.edu.in" class="dept">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4 mb-2">
        <a href="https://mba.sjcettnj.edu.in" class="dept">
